...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.getString(SEARCH_QUERY_URL_EXTRA) != null)
                mUrlDisplayTextView.setText(savedInstanceState.getString(SEARCH_QUERY_URL_EXTRA));
            if (savedInstanceState.getString(SEARCH_RAW_JSON) != null)
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String qurl = mUrlDisplayTextView.getText().toString();
        // complete (6) Using the key for the query URL, put the string in the outState Bundle
        outState.putString(SEARCH_QUERY_URL_EXTRA,qurl);
        ...
        outState.putString(SEARCH_RAW_JSON, results);
    }
